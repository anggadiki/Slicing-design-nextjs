        ...
        <div className="bg-menu">
          ...
          <div className=" flex flex-row pt-32">
            <div className=" w-2/12 flex items-center justify-start">
              <div className="xl:w-40 xl:h-20 lg:w-20 lg:h-20 bg-white rounded-r-full flex justify-end items-center pr-3">
            ...
            <div className=" w-2/12 flex items-center justify-end">
              <div className="xl:w-40 xl:h-20 lg:w-20 lg:h-20 bg-white rounded-l-full flex items-center pl-3">
